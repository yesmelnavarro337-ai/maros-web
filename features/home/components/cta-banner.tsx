  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-10">
      <div className="rounded-3xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
        <div className="bg-primary text-primary-foreground p-8 sm:p-10 md:p-12 flex flex-col justify-center gap-4">
          <p className="text-xs uppercase tracking-[0.3em] text-primary-foreground/70">
            Diseñamos tu idea
          </p>
          <h2 className="font-heading text-3xl sm:text-4xl leading-tight text-primary-foreground">
            ¿Lista para diseñar la pijama perfecta?
          </h2>
          <p className="text-primary-foreground/85 text-base leading-relaxed max-w-md">
            Escríbenos por WhatsApp y hagamos realidad tu idea — respondemos con propuesta, precio y tiempos.
          </p>
          <Button
            asChild
            size="lg"
            className="self-start mt-2 rounded-full bg-primary-foreground text-primary hover:bg-white/90 px-7"
          >
