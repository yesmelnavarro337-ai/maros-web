    ...
    <section className="bg-primary">
      <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-20 flex flex-col items-center text-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 15% 20%, color-mix(in oklch, var(--primary-foreground) 12%, transparent), transparent 40%), radial-gradient(circle at 85% 80%, color-mix(in oklch, var(--primary-foreground) 12%, transparent), transparent 40%)",
          }}
        />
        <div className="relative z-10 max-w-2xl flex flex-col items-center">
          <p className="text-xs uppercase tracking-[0.3em] text-primary-foreground/70 mb-3">
            ¿Lista para empezar?
          </p>
          <h2 className="font-heading text-3xl sm:text-5xl text-primary-foreground leading-tight">
            Hagamos realidad tu pijama ideal
          </h2>
          <p className="text-primary-foreground/85 mt-4 text-base sm:text-lg">
